...
function Popup({ children, title, onClose, isOpen, isDisabled = false, buttonText = "", handleSubmit }: PopupProps) {
  return (
    <div
    ...
    >
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-300 text-black w-[75%] h-[85%] overflow-y-auto scrollbar-none overflow-x-hidden py-5 rounded-2xl">
